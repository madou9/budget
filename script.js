...
function updateBudget() {
    budgetResume.textContent = `${totalBudget} $`;
    updateBalance();
}
...
function updateExpenses() {
    ...
    expenses.forEach((expense, index) => {
        ...
        expenseHTML += `
            <div class="row" id="expense-${index}">
                ...
                <div class="col s4 center">${expense.price} $</div>
    ...
    expenseResume.textContent = `${totalExpense} $`;
    balance.textContent = `${totalBudget - totalExpense} $`;
